...
export default async function LeagueOperatorLayout({ children }: LeagueOperatorLayoutProps) {
  ...
  // Check if user has league_operator role
  if (user.userRole !== 'league_operator') {
    redirect('/login');
  }
