...
import { getCharactersTableColumns, getCharactersTableActions } from './characters-table-columns';
...
export function CharactersPage({ gameSlug, title, subtitle }: CharactersPageProps) {
